...
<div _dynamic="@@(selector)(body @0)"></div> <!-- "Put this element before the 1nd element in the body element (index 0, meaning that it should be the first element after it's inserted, this is the same as `@top`)" -->
